...
function donneesClient(client) {
    ...
    $.ajax({
        method: "POST",
        url: "donneesClient.php", //url du script php
        data: {customerNumber : idClient} , //on définie les variables à envoyer 
        dataType: "json", //format json
        success: function(response){ //Si tout marche on traite le retour
